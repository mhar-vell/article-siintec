...
\makepagestyle{meuestilo}
  ...
  \makeevenhead{meuestilo} %%pagina par
   ...
   %   {centro \thepage}
   %   {direita}
     {}{}{VII INTERNATIONAL SYMPOSIUM ON INNOVATION AND TECHNOLOGY (SIINTEC)}
...
%     \end{minipage}
%     \hfill
%     \begin{minipage}{0.65\textwidth} \sf \small
%       % \theauthorref\ (\theyear).
%       % \thetitleref,
%       % \textit{\thejournal}, \thevolume(\theissue),
%       % pp.\ \thepages, DOI: https://doi.org/\thedoi
%       VII INTERNATIONAL SYMPOSIUM ON INNOVATION AND TECHNOLOGY (SIINTEC)\\
%       \rightline{\textit{One Planet, one Ocean and one Health. - 2021}}
%     \end{minipage}
%     \vspace{0.5em}
%     }
% }%
